...
#define MDC_MDIO_WRITE(preamableLength, phyID, regID, data) \
        bb_miiphy_write( "ravb", (unsigned char)(phyID), (unsigned char)(regID), (unsigned short)(data) )
#define MDC_MDIO_READ(preamableLength, phyID, regID, pData) \
        bb_miiphy_read( "ravb", (unsigned char)(phyID), (unsigned char)(regID), (unsigned short*)(pData) )
